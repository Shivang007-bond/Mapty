...
// const run1 = new Running([28,-77],12,4,30)
// const cycle1 = new Cycling([42,-72],12,4,60)
...
class App {
  ...
  _getPosition() {
    //Using Geolocation API (Browser API)
    if (navigator.geolocation)
      navigator.geolocation.getCurrentPosition(
        this._loadMap.bind(this),
        function () {
          alert("Unable to access position (Allow pop-ups)");
        }
      );
  }
